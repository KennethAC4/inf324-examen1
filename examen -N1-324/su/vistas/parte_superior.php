...
<body>
    <header class="main-header"  style="background-color: <?php
                                  ...
                                  $query="SELECT color from administrador WHERE email='$correo' and  contraseña='$contraseña'";
      ...
      <div class="container container--flex">
        <a href="superusuario.php"><h1 class="main-title"><span class="color-span">KF</span>AR</h1></a>
        <nav class="main-nav">
          <span class="icon-menu" id="btn-menu"><i class="fas fa-bars"></i></span>
          <ul class="menu" id="menu">
            <li class="menu__item"><a href="modneg.php" class="menu__link"><span>Docentes</span></a></li>
            <li class="menu__item"><a href="moduser.php" class="menu__link"><span>Estudiantes</span></a></li>
            ...
            <li class="menu__item">
              ...
              $query="SELECT usuario from administrador WHERE email='$correo' and  contraseña='$contraseña'";
              $consulta = pg_query($conexion,$query);
    ...
    <script type="text/javascript" src="http://localhost:8080//examen%20-N1-324/menu.js"></script>  
</body>
</html>
