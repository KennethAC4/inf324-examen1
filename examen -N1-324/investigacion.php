...
<body>
    ...
    <div class="banner" style = "background: url(http://localhost:8080/img/investigacion.png); min-height:530px ">
      <div class="banner__content">
        <div class="container">
          <h2 class="banner__title"></h2>
          <p class="banner__txt">instituto de investigacion</p>
        </div>
      </div>
    </div>
    <main class="main">
      <section class="welcome">
        ...
        <h2 class="section__title">Pregunta 1</h2>
        <p class="welcome__txt">Genere una plantilla utilizando PHP, 
          con su maquetación que permita el acceso a la información de la carrera, kardex e Instituto de investigación. </p>
